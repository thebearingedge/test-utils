...
exports.chaiHttp = exports.chaiDom = exports.testBean = exports.testVue = exports.Globals = exports.$$ = exports.$ = exports.rejected = exports.begin = exports.jsdom = exports.stub = exports.spy = exports.expect = undefined;
...
function testBean() {
  var cwd = process.cwd();
  var beanFile = 'node_modules/bean/bean.js';
  var beanPath = (0, _path.join)(cwd, beanFile);
...
var begin = function begin(knex, ready) {
  return function (done) {
    rejected(knex.transaction(function (_trx) {
      ready(_trx);
      done();
    }));
  };
