...
exports.default = {
  expect: expect, spy: spy, stub: stub, jsdom: _jsdom.jsdom, $: $, $$: $$, Globals: Globals, testVue: testVue,
  chaiDom: function chaiDom() {
    _chai2.default.use(_chaiDom3.default);
  },
  chaiHttp: function chaiHttp(app) {
